...
#	echo "cmdArea    Yes" >> "$file"
    ...
    # If a file exists, assume it is correct and only create one if
    # none exists
    if test ! -e $file
    then
        echo "Creating $file"
...
#    db_adm="postgres"
    ...
    echo "vnmr_adm: $vnmr_adm, home_dir: $home_dir"
...
then
  ...
  vnmradm_home_dir="C:/SFU/home/$vnmr_adm"
  vnmruser="/home/$vnmr_adm/vnmrsys"
  vnmruser_dir="C:/SFU/home/$vnmr_adm/vnmrsys"
fi
...
updateadminfiles $vnmr_adm "$vnmradm_home_dir"

...
/* Since we are so close to 1st release I'm not going to enable the new DPRINT macros , 3/11/05 GMB */
#ifndef NEW_LOG_MACROS     /* new style uses while() that allows ';' to be used after DPRINT in an if-else */
...
/* the use of while() allows common syntax error with macros to be handled properly */ 

#define DPRINT(level, str) \
         do { if (DebugLevel > level) \
              { diagPrint(debugInfo,str); } \
            } while (0)

#define DPRINT1(level, str, arg1) \
        do { if (DebugLevel > level) \
             { diagPrint(debugInfo,str,arg1); } \
           } while (0)

#define DPRINT2(level, str, arg1, arg2) \
        do { if (DebugLevel > level) \
             { diagPrint(debugInfo,str,arg1,arg2); } \
           } while (0)
 
#define DPRINT3(level, str, arg1, arg2, arg3) \
        do { if (DebugLevel > level) \
             { diagPrint(debugInfo,str,arg1,arg2,arg3); } \
           } while (0)
 
#define DPRINT4(level, str, arg1, arg2, arg3, arg4) \
        do { if (DebugLevel > level) \
            { diagPrint(debugInfo, str,arg1,arg2,arg3,arg4); } \
           } while (0)
 
#define DPRINT5(level, str, arg1, arg2, arg3, arg4, arg5 ) \
        do { if (DebugLevel > level) \
             { (debugInfo,str,arg1,arg2,arg3,arg4,arg5); } \
           } while (0)
 
#define DPRINT6(level, str, arg1, arg2, arg3, arg4, arg5, arg6 ) \
        do { if (DebugLevel > level) \
             { diagPrint(debugInfo,str,arg1,arg2,arg3,arg4,arg5,arg6); } \
           } while (0)

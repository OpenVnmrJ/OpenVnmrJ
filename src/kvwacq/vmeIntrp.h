...
/* 
   ...
   Console:
	...
	0x69 - 0x6F : ADC 1 vector per Board (total 8)
...
#define FIFO_ALMOST_EMPTY_ITRP_VEC 	0x01
#define FIFO_ALMOST_FULL_ITRP_VEC 	0x00
...
#define STM_DATA_ERROR_ITRP_VEC 	0xB0

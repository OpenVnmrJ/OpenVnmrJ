...
/* --- OUTPUT Boards --- */
#define FIFO_BASE_ADR 	0xFFFF0000L
...
/* --- STM Boards --- */
#define STM_BASE_ADR	0xFFFF0000L
...
/* --- ADC board --- */
#define ADC_BASE_ADR	0xFFFF0000L
...
#ifdef STM_V1
#define STM_CR		0x0801	/* 8 bits -/W */
#else
#define STM_CR		0x0801	/* 8 bits -/W,only lower 8 bits meaningfull */
#endif

#define STM_SR		0x0805	/* 16 bits R Only */

/* BIG ENDIAN ORDER */
/* Read Registers 16-bit access only (no 32-bit) */
#define STM_SRC_ADR0	0x00	/* Source Address low word (16 bits) */
#define STM_SRC_ADR1	0x00	/* Source Address High word (16 bits) */
#define STM_DST_ADR0	0x00	/* Destination Address low word (16 bits) */
#define STM_DST_ADR1	0x00	/* Destination Address High word (16 bits) */
#define STM_NP_CNT0	0x0907	/* Remaining # Points low  byte (8 bits) */
#define STM_NP_CNT1	0x0909	/* Remaining # Points med  byte (8 bits) */
#define STM_NP_CNT2	0x090B	/* Remaining # Points high byte (8 bits) */
#define STM_CT_CNT0	0x0901	/* Remaining # Transients low byte (8 bits) */
#define STM_CT_CNT1	0x0903	/* Remaining # Transients med byte (8 bits) */
#define STM_CT_CNT2	0x0905	/* Remaining # Transients high byte (8 bits) */
#define STM_TAG_ADDR	0x090D	/* Tag Word low byte (8 bits) */
#define STM_TAG_ADDR1	0x090F	/* Tag Word high byte (8 bits) */
...
#define CT_COMPLETE 	0x20	/* Mbit 5 - Remaining Transients ==0 if bit=1 */
#define NP_INCOMPLETE 	0x10	/* Mbit 4 - Remaining Points != 0 if bit=1 */
#define MAX_SUM		0x40	/* Mbit 6 - Maxsum met or execeeded if bit=1 */
...
#define ADM_ADCOVFL_MASK 0x0	/* bit 3 - Enable HS DTM's ADC OverFlow interrupt if bit=1 */
#define RTZ_ITRP_MASK   0x01	/* bit 1 - Enable RTZ interrupt if bit=1 */
#define RPNZ_ITRP_MASK 	0x02	/* bit 5 - Enable RPNZ if bit=1 */
#define MAX_SUM_ITRP_MASK 0x02	/* Mbit 6 - Enable Maxsum interrupt if bit=1 */
#define APBUS_ITRP_MASK	0x00	/* bit 7 - Enable APbus interrupt if bit=1 */
#define STM_RESET	0x08	/* bit 8 - Reset STM Board if bit=1 */
#define FAKE_CTC_PULSE	0x000	/* bit 9 - Fake CTC Pulse if bit=1 */
#define MAXSUM_ADMOVFL_RESET 0x000 /* bit 10 - Reset HSADM MAX_SUM and ADC OverFlow if bit=1 */

#define STM_ALLITRPS	0x03	/* VME Interrupt Bits 1 */

/* STM APbus Register Offset Addresses */

#define STM_AP_CR	0x00	/* AP Sequence Control Register */
#define STM_AP_TAG_ADDR	0x0e	/* Tag Word (16 bits) */
#define STM_AP_SPARE1	0x0e
#define STM_AP_SPARE2	0x0e
#define STM_AP_SPARE3	0x0e
#define STM_AP_SPARE4	0x0e

#define STM_AP_MAXSUM0	0x0e	/* Maxsum word 0 */
#define STM_AP_MAXSUM1	0x0e	/* Maxsum word 1 */
#define STM_AP_SRC_ADR0	0x10	/* Source Address low word (16 bits) */
#define STM_AP_SRC_ADR1	0x0e	/* Source Address High word (16 bits) */
#define STM_AP_DST_ADR0	0x0e	/* Destination Address low word (16 bits) */
#define STM_AP_DST_ADR1	0x0e	/* Destination Address High word (16 bits) */
#define STM_AP_NP_CNT0	0x09	/* Remaining # Points low byte (8 bits) */
#define STM_AP_NP_CNT1	0x08	/* Remaining # Points med byte (8 bits) */
#define STM_AP_NP_CNT2	0x07	/* Remaining # Points high byte (8 bits) */
#define STM_AP_NTR_CNT0	0x06	/* Remaining # Transients low byte (8 bits) */
#define STM_AP_NTR_CNT1	0x05	/* Remaining # Transients med byte (8 bits) */
#define STM_AP_NTR_CNT2	0x04	/* Remaining # Transients high byte (8 bits) */
...
#define STM_AP_SINGLE_PRECISION  0x00   /* bit 4 - 1=16 bit, 0=32 bit */
#define STM_AP_ENABLE_ADC1	 0x00   /* bit 5 - Enable STM */
#define STM_AP_ENABLE_ADC2	 0x00   /* bit 6 - Enable STM */
#define STM_AP_ENABLE_STM	 0x00   /* bit 7 - Enable STM */
#define STM_AP_RELOAD_NP_ADDRS	 0x20   /* bit 8 - Reload Addresses */
#define ADM_AP_OVFL_ITRP_MASK    0x00   /* bit 11 - En. HS DTM ADC's OverFlow */
#define STM_AP_RTZ_ITRP_MASK     0x20   /* bit 12 - En. Remaining transients==0 */
#define STM_AP_RPNZ_ITRP_MASK    0x10	/* bit 13 - En. Remaining Pts != 0  */
#define STM_AP_MAX_SUM_ITRP_MASK 0x40	/* bit 14 - Enable Maxsum interrupt */
#define STM_AP_IMMED_ITRP_MASK   0x80	/* bit 15 - Enable Immediate interrupt */
...
/* -------------------------------------------------------*/
#define PFIFO_WRITE 	0x90000000L	/* Write into Pre-FIFO 64-bit */
...
#define AP_RD_BK_FIFO	0x080C	/* Apbus Read Back Fifo  (16-bit)*/

/* -------------------------------------------------------*/
#define TAG_FIFO	0x080E	/* TAG Value 18-bits */

/* -------------------------------------------------------*/
#define FIFO_SR		0x080a	/* 8 bits */

/* --- Definition of Bits --- */
#define FNOTRUNNING	0x0000080L  	/* Fifo running if bit=1 */
#define FLOOPING	0x0000040L  	/* Fifo Looping if bit=1 */
#define FNOTEMPTY	0x0000002L  	/* Fifo Not Empty if bit=1 */
#define FNOTFULL	0x0000000L  	/* Fifo Not Full  if bit=1 */
#define PFNOTEMPTY	0x0000002L  	/* Pre Fifo Not Empty if bit=1 */
#define PFAMEMPTY	0x0000010L  	/* Pre Fifo Almost Empty if bit=1 */
#define PFAMFULL	0x0000020L  	/* Pre Fifo Almost Full if bit=1 */
#define PFNOTFULL	0x0000000L	/* pre Fifo Not Full if bit=1 */
#define FSTRTEMPTY	0x0000008L	/* Fifo Started while empty if bit=1 */
#define FSTRTHALT	0x0000001L	/* Fifo Started with haltop if bit=1 */
#define	LOCK_SENSE	0x0000400L	/* Lock sense for Mercury */
#define NETBL		0x0000400L	/* Not Enough Time Between Loops */
#define FORP		0x0000800L	/* FIFO Out Run Pre-fifo */
#define SPIN_SENSE	0x0001000L	/* Spin sense for Mercury */
#define FSTOPOEMPTY	0x0000001L	/* FIFO Stopped Empty, not HALTOP */
#define APTIMEOUT	0x0000100L	/* APbus Time Out */
#define RESERVE1	0x0004000L	/* */
#define RESERVE2	0x0008000L	/* */
#define APRDBKFNEMPTY 	0x0000000L	/* APbus Read Back FIFO Not Empty */
...
/* -------------------------------------------------------*/
#define FIFO_CR		0x0801	/* 8 bits */
/* --- Definition of Bits --- */
#define STARTFIFO	0x10	/* Start the FIFO */
#define STARTONSYNC	0x20	/* Start on Sync */
#define STARTONXGATE	0x60	/* Start on External Sync */
#define AUTOSTART	0x00	/* Auto Start NOMERCURY*/
#define RESETFIFO	0x02	/* Reset FIFO */
#define RESETSTATEMACH	0x01	/* Reset State Machine */
#define RESETAPBUS	0x04	/* Reset AP Bus */
#define RESETTAGFIFO	0x00	/* Reset TAG FIFO NOMERCURY*/
#define RESETAPRDBKFIFO	0x00	/* Reset APbus Read Back FIFO NOMERCURY*/
#define RESETFIFOBRD    0x03	/* Reset Entire Board */
...
/* -------------------------------------------------------*/
#define FIFO_INTRP_MASK	0x0807	/* FIFO Interrupt Mask */
/* --- Definition of Bits (positive logic, bit=1) --- */
#define PFAMEMPTY_I	0x0040	/* Pre-Fifo Almost Empty */
#define PFAMFULL_I	0x0080  /* Pre Fifo Almost Full */
#define FSTOPPED_I	0x0020  /* Fifo Stopped */
#define FSTRTEMPTY_I	0x0010	/* Fifo Started while empty */
#define FSTRTHALT_I	0x0010	/* Fifo Started with haltop */
#define NETBL_I		0x0010	/* Not Enough Time Between Loops */
#define FORP_I		0x0000	/* FIFO Out Run Pre-fifo */
#define NETBAP_TOUT_I 	0x0000  /* Not Enough Time Between APbus or AP Timeout*/
#define SW1_I 		0x0000  /* Software Programmed Intrp 1 */
#define SW2_I 		0x0000  /* Software Programmed Intrp 2 */
#define SW3_I 		0x0000  /* Software Programmed Intrp 3 */
#define SW4_I 		0x0000  /* Software Programmed Intrp 4 */
#define TAGFNOTEMPTY_I	0x0004  /* TAG FIFO NOT Empty */
#define TAGFAFULL_I 	0x0000  /* TAG FIFO Almost Full */
#define APRDBKFNEMPTY_I 0x0000  /* APbus Read Back FIFO Not Empty */
#define APRDBKFAFULL_I	0x0000  /* APbus Read Back FIFO Almost Full */
#define FF_ALLITRPS	0x00FC  /* All Fifo interrupt Bits */

/* Control Lines for FIFO Word in 32 bit integer */
/* The control lines are the 8 msb's of the 64 or 96 bit fifo word */
/*			  87654321      */
#define	RSYNC		0x00000000	/* NOMERCURY */
#define	EXTCLK		0x00000000	/* NOMERCURY */
#define	SWINTRP		0x00000000 /* just the control field */	/* NOMERCURY */
#define	SWIDTAG		0x07000000
#define	CTC		0x01000000
#define	LPSTRT		0x02000000
#define	LPEND		0x04000000
#define	LPCNT		0x06000000
#define APSLCT		0x0000A000
#define APWRT		0x0000B000
#define APINCWR		0x00009000
#define APRD		0x0000F000
#define HALTOP		0x0000E000
#define	SWINT1		0x00000000	/* NOMERCURY */
#define	SWINT2		0x00000000	/* NOMERCURY */
#define	SWINT3		0x00000000	/* NOMERCURY */
#define	SWINT4		0x00000008	/* NOMERCURY */

#define HS_LINE_MASK	0x000001FF
#define HS_LINE_SHIFT	16		/* NEWMERCURY */
#define CW_DATA_FIELD_MASK 0x0000FFFF
#define DATA_FIELD_SHFT_IN_HSW	5	/* NOMERCURY */
#define DATA_FIELD_SHFT_IN_LSW	27	/* NOMERCURY */
...
#define CL_AP_BUS       APSLCT
#define CL_AP_BUS_SLCT  APSLCT
#define CL_AP_BUS_WRT   APWRT
#define CL_AP_BUS_INCWR APINCWR
#define CL_AP_BUS_RD    APRD
...
#define ADC_RESET	 0x0008	/* ADC Reset Board */
#define ADC_FAKE_CT	 0x0200	/* Fake CTC for ADC */

#define ADC_ALLITRPS	 0x0004  /* All ADC interrupt Bits */
...
#define RCV1_OVERLD_LATCHED	0x10	/* Recv 1  overload has occurred */
#define RCV2_OVERLD_LATCHED	0x20	/* Recv 2  overload has occurred */
#define ADC_OVERFLOW_LATCHED	0x01	/* ADC overflow has occurred */
#define SPARE_MASK_LATCHED	0x80	/* SPARED Bit */
...
#define ADC_AP_CHANSELECT_POS	  0
...
* hardware macros
*/
#define FF_IMASK(a)	((volatile unsigned char*  const) (FIFO_INTRP_MASK + (a)))
#define FF_STATR(a)	((volatile unsigned short* const) (FIFO_SR + (a)))
#define FF_OPTSR(a)	( (volatile unsigned long*  const) (FIFO_OPSR + (a)))
#define FF_CNTRL(a)	((volatile unsigned char*  const) (FIFO_CR + (a)))
#define FF_PFLW(a)	((volatile unsigned long*  const) (PFIFO_WRITE))
...
#define FF_APRDBK(a)	((volatile unsigned short* const) (AP_RD_BK_FIFO + (a)))
#define FF_TAGFF(a)	((volatile unsigned short* const) (TAG_FIFO + (a)))
...
#define STM_STATR(a)	((volatile unsigned char*  const) (STM_SR + (a)))
#define STM_CNTLR(a)	((volatile unsigned char*  const) (STM_CR + (a)))
#define STM_TAG(a)	((volatile unsigned char*  const) (STM_TAG_ADDR + (a)))
#define STM_TAG1(a)	((volatile unsigned char*  const) (STM_TAG_ADDR1 + (a)))
#define STM_CTHW(a)	((volatile unsigned char*  const) (STM_CT_CNT2 + (a)))
#define STM_CTMW(a)	((volatile unsigned char*  const) (STM_CT_CNT1 + (a)))
#define STM_CTLW(a)	((volatile unsigned char*  const) (STM_CT_CNT0 + (a)))
#define STM_NPHW(a)	((volatile unsigned char*  const) (STM_NP_CNT2 + (a)))
#define STM_NPMW(a)	((volatile unsigned char*  const) (STM_NP_CNT1 + (a)))
#define STM_NPLW(a)	((volatile unsigned char*  const) (STM_NP_CNT0 + (a)))
...
#define ADC_STATR(a)	((volatile unsigned char* const) (ADC_SR + (a)))
#define ADC_CNTRL(a)	((volatile unsigned char* const) (ADC_CR + (a)))

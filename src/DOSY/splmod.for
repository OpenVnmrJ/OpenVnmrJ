...
C                                                                       MAIN0063
      DIMENSION        Y(1024,1), T(1024,1), YLYFIT(1024,1),            MAIN0064
     1                 SQRTW(1024,1), RESPON(1024)                      MAIN0065
      DIMENSION        PLAM(10),   PLMTRY(10), EPK(10), DELTAN(10),     MAIN0066
     1                 NOKSET(10), NCOMBI(10),  DX(10),     IC(10)      MAIN0067
      DIMENSION        BSPL0(4,10), BSPL1(4,10), BSPL2(4,10)               MAIN0068
      DIMENSION        PLMSAV(10,10), DELTAH(10,1)                        MAIN0069
      DIMENSION        GTG(10,10)                                         MAIN0070
      DIMENSION        EK(14), DELTAL(14)                                 MAIN0071
      DIMENSION        PLIN(14,1), PLNTRY(14,1), PIVLIN(14,1), R(14,1)      MAIN0072
      DIMENSION        ETE(14,14)                                         MAIN0073
      DIMENSION        EKEK(14,14,1), ASAVE(14,14,1), H(14,14,1)              MAIN0074
      DIMENSION        NY(1), YW(1), ERRFIT(1)                          MAIN0075
      DIMENSION        PIVLAM(24), DTOLER(24), BUFF(24)                 MAIN0076
      DIMENSION        ATOT(24,24)                                      MAIN0077
      DIMENSION        ZGRID(52), D(52), U(52), WORK(52), BETA(52)      MAIN0078
      DIMENSION        CCAP(52,52,1), ECAP(52,4,1), YCAP(52,1),         MAIN0079
     1                 SGGCAP(4,4,1), SGYCAP(4,1)                       MAIN0080
      DIMENSION        STARTV(200)                                       MAIN0081
C                                                                       MAIN0082
...
C                                                                       MAIN0139
      DATA             NYMAX /1024/, NDMAX /1/, NONLMX /10/, NGAMMX/4/  MAIN0140
C                                                                       MAIN0141
C  NLINMX = NONLMX + NGAMMX                                             MAIN0142
C  NLNDMX = NDMAX * NLINMX + NONLMX                                     MAIN0143
C                                                                       MAIN0144
      DATA             NLINMX/14/, NLNDMX /24/                          MAIN0145
C                                                                       MAIN0146
      DATA             NZMAX  /52/, MTRYMX/200/                         MAIN0147
C                                                                       MAIN0148

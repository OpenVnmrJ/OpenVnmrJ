...
/* bsEXSIDE - Double band-selective EXSIDE to measure long-range
   coupling constants
...
Krish Krishnamurthy - Aug. 95 (original EXSIDE)

[REF: V.V. Krishnamurthy, JMR, A121, 33-41 (1996)]

Krish Krishnamurthy - Oct. 2004 (revised)

Craig Butts, Univ. Bristol, UK, Bert Heise, Agilent UK - Feb. 2012
  (double band-selective)
...
status(A);
  ...
  status(B);
    ...
    delay(jdly/4);
        ...
        obspower(selpwrA);
        decpower(selpwxlvlA);
//First X Selective Pulse
//        decshaped_pulse(selpwxshpA, selpwxA, zero, rof1, rof1);
//        shaped_pulse(selshapeA,selpwA,zero,rof1,rof1);
simshaped_pulse(selshapeA,selpwxshpA,selpwA,selpwxA,zero,zero,rof1,rof1);
        zgradpulse(gzlvlA,gtA);
        delay(gstab);
    ...
    delay(tau/2 - gtB - gstab);
        ...
        obspower(selpwrB);
        decpower(selpwxlvlB);
//Second X Selective Pulse
//        decshaped_pulse(selpwxshpB, selpwxB, zero, rof1, rof1);
//        shaped_pulse(selshapeB,selpwB,two,rof1,rof1);
simshaped_pulse(selshapeB,selpwxshpB,selpwB,selpwxB,two,zero,rof1,rof1);
	obspower(tpwr);
        zgradpulse(gzlvlB,gtB);
        delay(gstab);
	decpower(pwxlvl);

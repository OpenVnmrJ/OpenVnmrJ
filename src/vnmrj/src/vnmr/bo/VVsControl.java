...
public class VVsControl extends VPlot {
	...
	{Integer.valueOf(GRAPHBGCOL),   "Background Color:", "color"},
	{Integer.valueOf(GRAPHFGCOL),   "Histogram Color:", "color"},
	...
	{Integer.valueOf(RANGE),        "String Specifying the Function:"},
	{Integer.valueOf(PATH1),        "File for Color Lookup Table:"},
    };

...
public class VParameter extends VGroup implements ExpListenerIF
{
    ...
    private final static Object[][] attributes = {
        {Integer.valueOf(VAR2),         "Parameter Name:"},
        {Integer.valueOf(LABEL),        "Label of item:"},
        {Integer.valueOf(ENABLED),         "Enable Condition:"},
        {Integer.valueOf(VARIABLE),     "Vnmr variables:    "},
        {Integer.valueOf(CHECKENABLED), "Checkbox Enable Condition:"},
        {Integer.valueOf(CHECKVALUE),   "Checkbox Value:"},
        {Integer.valueOf(CHECKCMD),     "Checkbox Vnmr Command:"},
        {Integer.valueOf(CHECKCMD2),    "Checkbox Vnmr Command2:"},
        {Integer.valueOf(ENTRYVALUE),   "Entry value:"},
        {Integer.valueOf(ENTRYSIZE),    "Entry size:"},
        {Integer.valueOf(ENTRYCMD),     "Entry Vnmr Command:"},
        {Integer.valueOf(NUMDIGIT),     "Entry Decimal Places:"},
        {Integer.valueOf(DISABLE),      "Entry Disable Style:", "menu", VEntry.m_arrStrDisAbl},
        {Integer.valueOf(UNITSENABLED), "Units Enable:", "menu", UNITS},
        {Integer.valueOf(UNITSSIZE),    "Units size:"},
        {Integer.valueOf(UNITSLABEL),   "Units Label:"},
        {Integer.valueOf(UNITSVALUE),   "Units value:"},
        {Integer.valueOf(UNITSCMD),     "Units Vnmr Command:"},
        {Integer.valueOf(CHVAL),       "Menu Choice Label:"},
        {Integer.valueOf(VALUES),        "Menu Choice Value:"},
    };

    ...
    implements VEditIF, PropertyChangeListener, VStatusChartIF
{
    ...
    private final static Object[][] attributes = {
        ...
        {Integer.valueOf(GRAPHBGCOL),   "Graph Background Color:", "color"},
        {Integer.valueOf(GRAPHFGCOL),   "First Mark Color:", "color"},
        {Integer.valueOf(GRAPHFGCOL2),  "Second Mark Color:", "color"},
        {Integer.valueOf(GRAPHFGCOL3),  "Third Mark Color:", "color"},
        {Integer.valueOf(POINTSIZE),    "Point Size for Scatter Plot:", "menu",
         m_arrStrPtSz},
        {Integer.valueOf(JOINPTS),      "Connect Points in ScatterPlot:", "radio",
         m_arrStrYesNo},
        //{Integer.valueOf(FILLHISTGM),   "Fill Histogram:", "radio", m_arrStrYesNo},
        {Integer.valueOf(LOGYAXIS),     "Log Y-axis:", "radio", m_arrStrYesNo},
        {Integer.valueOf(XAXISSHOW),    "Show X-axis:", "radio", m_arrStrYesNo},
        {Integer.valueOf(XLABELSHOW),   "Show X-axis label:", "radio",
         m_arrStrYesNo},
        {Integer.valueOf(YAXISSHOW),    "Show Y-axis:", "radio", m_arrStrYesNo},
        {Integer.valueOf(YLABELSHOW),   "Show Y-axis label:", "radio",
         m_arrStrYesNo},
        {Integer.valueOf(TICKCOLOR),    "Tick color:", "color"},
        {Integer.valueOf(SHOWGRID),     "Show grid:", "radio", m_arrStrYesNo},
        {Integer.valueOf(GRIDCOLOR),    "Grid color:", "color"},
        {Integer.valueOf(LCSETVAL),     "Value of item for left cursor:"},
        {Integer.valueOf(LCSHOW),       "Enable left cursor condition:"},
        {Integer.valueOf(LCCMD),        "Vnmr cmd for left cursor button release:"},
        {Integer.valueOf(LCCMD2),       "Vnmr cmd for left cursor button press:"},
        {Integer.valueOf(LCCMD3),       "Vnmr cmd for left cursor button drag:"},
        {Integer.valueOf(LCCOLOR),      "Color for left cursor:", "color"},
        {Integer.valueOf(RCSETVAL),     "Value of item for right cursor:"},
        {Integer.valueOf(RCSHOW),       "Enable right cursor condition:"},
        {Integer.valueOf(RCCMD),       "Vnmr cmd for right cursor button release:"},
        {Integer.valueOf(RCCMD2),       "Vnmr cmd for right cursor button press:"},
        {Integer.valueOf(RCCMD3),       "Vnmr cmd for right cursor button drag:"},
        {Integer.valueOf(RCCOLOR),      "Color for right cursor:", "color"}

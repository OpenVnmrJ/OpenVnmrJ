#
# Note to use this pro file first make a jar of only the vnmr directory in classes
# jar -cvf jvnmrj.jar -C classes vnmr
# then run proguard, 
# e.g. ../../3rdParty/java/bin/java -jar ../../3rdParty/ProGuard/proguard4.3/lib/proguard.jar @JVnmrJ.pro
#
#  fails with optimazation but differnetly from the VnmrJ.pro
...
-libraryjars ./comm.jar
-libraryjars ./jcfield.jar  
-libraryjars ./jhbasic.jar
-libraryjars ./jhtools.jar 
-libraryjars ./jmol.jar
-libraryjars ./jsearch.jar
-libraryjars ./lcaccess.jar
-libraryjars ./pdaaccess.jar
-libraryjars ./vjmol.jar
-libraryjars ./xml.jar
-libraryjars ./gluegen-rt.jar
-libraryjars ./jhall.jar
-libraryjars ./jh.jar
-libraryjars ./jmf.jar
-libraryjars ./jogl.jar
-libraryjars ./msaccess.jar
-libraryjars ./postgresql.jar

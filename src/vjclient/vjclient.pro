...
# read in the vjclient.jar for analysis
-injars  vjclient.jar
# output directory for new obfuscated vjclient.jar file
-outjars vjclient.prodir

-printmapping vjclient.pro.map
...
-keepnames class vnmr.wizard.navigator.Navigator {
    public <methods>;
}
-keep class vnmr.wizard.navigator.DefaultNavigator

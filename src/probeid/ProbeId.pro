...
# read in the probeid.jar for analysis
-injars  probeid.jar
# output directory for new obfuscated probeid.jar file
-outjars probeid.prodir

-printmapping probeid.pro.map
-dump probeid.pro.dump
...
-keep public interface vnmr.probeid.ProbeId

# ManageDB classes and methods not to managle (if used)
#-keepnames class vnmr.probeid.ProbeIdIO {
#    public <methods>;
#}
-keep class vnmr.probeid.ProbeIdIO
-keep class vnmr.probeid.ProbeIdPipeServer

/*hetcordumbolgcp2d_1.c - A sequence to provide correlation between the
               X chemical-shift and H chemical shift obtained with
	       DUMBO. Uses an offset (Lee Goldburg) CP for mixing. 
               D.Rice from Hetcorlgcp2d 12/15/05. 

               Uses Z-rotation DUMBO and a 90-degree prep pulse. 

	       Allows offset  and tilt pulses to shift the F1
...
static int table2[4] = {0,0,0,0};           // phHdumbo
...
// Define Variables and Objects and Get Parameter Values
   ...
   double d22 = dh.t/2.0 - pwX180/2.0;
   if (d22 < 0.0) d22 = 0.0;

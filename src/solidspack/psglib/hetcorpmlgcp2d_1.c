/*hetcorpmlgcp2d_1.c - A sequence to provide correlation between the
               X chemical-shift and H chemical shift obtained with
	       PMLGn. Uses an offset (Lee Goldburg) CP for mixing. 
               D.Rice from Hetcorlgcp2d 12/15/05. 

               Uses Z-rotation PMLG and a 90-degree prep pulse. 
...
static int table2[4] = {0,0,0,0};           // phHpmlg

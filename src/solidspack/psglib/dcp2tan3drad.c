/*dcp2tan3drad.c  DCP with an F1 Mix period for 15N, F2 for 13C and F3 fopr 13C.
...
static int table8[8] = {1,1,2,2,3,3,0,0};   // phXmix1
static int table9[8] = {3,3,0,0,1,1,2,2};   // phXmix2

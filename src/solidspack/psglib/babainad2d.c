/*babainad2d.c - A sequence to provide homonuclear correlation with
...
// Dutycycle Protection
   ...
   d.dutyon = getval("pwH90") + getval("tHX") + 2.0*getval("pwX90") + baba.t + babaref.t; 

/*mqmas3qfam2spltse2d.c - A sequence to generate a two pulse MQMAS 2D spectrum
                   for which the second pulse uses FAM2, with a selective echo
...
static int table1[12] = {0,30,60,90,120,150,180,210,240,270,300,330};
                                        // phf1Xmqmas
static int table2[6] = {0,0,0,0,0,0};   // ph1Xfam2
static int table3[6] = {2,2,2,2,2,2};   // ph2Xfam2
...
static int table7[6] = {0,0,0,0,0,0};          // ph1Xfam2
static int table8[6] = {2,2,2,2,2,2};          // ph2Xfam2
